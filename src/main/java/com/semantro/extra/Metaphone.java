package com.semantro.extra;

/**
 * This class is a part of the package com.semantro.extra and the package
...
public class Metaphone {
     ...
     *
     * @param in primary encoding character to be added to encoded key string.
     */
